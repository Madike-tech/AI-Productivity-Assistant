...
Converts meeting notes into a concise summary containing important points, decisions and action items.
3. Task Planner
Breaks larger tasks into manageable steps and helps users organise priorities.
4. Research Assistant
Helps users structure research topics, questions, keywords and information.
5. AI Chatbot
Provides general productivity and administrative assistance through conversational interaction.
AI Tools
The project demonstrates the use of AI tools such as:
ChatGPT
Gemini
Notion AI
...
Reviewing AI-generated information before using it.
